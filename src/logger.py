...
def loggerBossHunt():
  logger('🗺️ Boss Hunt clicked!')
  logger_file = open("./logs/boss_hunt.log", "a", encoding='utf-8')
  logger_file.write(dateFormatted() + '\n')
  logger_file.close()

def loggerBossFight():
  logger('🗺️ Boss Fight clicked!')
  logger_file = open("./logs/boss_fight.log", "a", encoding='utf-8')
  logger_file.write(dateFormatted() + '\n')
  logger_file.close()